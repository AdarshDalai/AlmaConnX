  ...
  return (
    <div className="homepage-container">
      <div className="briefInfo">
        <div className="cover-pic-homepage">
          <img
        ...
        <div className="info-homepage">
          <p><strong>NAME: Nirmal</strong></p>
          <p><strong>BRANCH: CSE</strong></p>
          <p><strong>INTEREST: Sleep</strong></p>
        </div>
      </div>
      <div className="main-content">
        <div className="ai--part">
          <h2>
            {userType === "alumni" ? "AI Suggested Students" : "AI Suggested Alumni"}
          </h2>
          <textarea
            name="content"
